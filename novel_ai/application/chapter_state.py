"""Read model chương/revision thuần Python cho adapter và WebUI tương lai."""
...
from novel_ai.core.models import ChapterMetadata, ChapterStatus, DependencyPin, ReconciliationStatus
...
from novel_ai.application import arbiter
